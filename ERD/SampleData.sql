...
INSERT INTO APP.CLIENTS (PASSWORD, "FULLNAME", PHONE, ADDRESS, VERIFIED, BONUS) 
	VALUES ('12345678', 'Vault Boy', 23382338, 'Vault 101', true, 3000);
INSERT INTO APP.CLIENTS (PASSWORD, "FULLNAME", PHONE, ADDRESS, VERIFIED, BONUS) 
	VALUES ('87654321', 'Steven', 23800000, 'Vault 111', true, 1000);
INSERT INTO APP.CLIENTS (PASSWORD, "FULLNAME", PHONE, ADDRESS, VERIFIED, BONUS) 
	VALUES ('65498741', 'Eric', 24681357, 'Vault 111', true, 1333);
INSERT INTO APP.CLIENTS (PASSWORD, "FULLNAME", PHONE, ADDRESS, VERIFIED, BONUS) 
	VALUES ('65489468', 'Carlyle', 36696940, 'Vault 111', true, 1234);
INSERT INTO APP.CLIENTS (PASSWORD, "FULLNAME", PHONE, ADDRESS, VERIFIED, BONUS) 
	VALUES ('98765432', 'Cedric', 36996336, 'Vault 111', false, 0);
